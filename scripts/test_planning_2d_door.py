...
#    exit(0)
    ...
    env_xml = EnvironmentXml("/home/dseredyn/ws_stero/src/multilevel_planning/data/environments/env_door.xml")
...
#        InformationDestinationGeom( dest_point ),                               # target point for motion
        InformationOpenDoorCommand("cabinet_left_door", math.pi/2.0),
#        info_exp_motion,
#        move_command,
    ]
